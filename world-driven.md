...
### The `/worldkit.worldbuild` Command
...
# Use the worldbuild command to create the baseline description
/worldkit.worldbuild Real-time chat system with message history and user presence
...
# Step 2: Generate high-level outline (5 minutes)
# Use the outline command to create a high-level plan for structure and components
/worldkit.outline WebSocket for real-time messaging, PostgreSQL for history, Redis for presence

# Step 3: Generate actionable breakdown (5 minutes)
# Use chapters/checklist to break the outline into actionable items
/worldkit.chapters
...
```text
Every feature in Worldbuild MUST begin its existence as a standalone library.
